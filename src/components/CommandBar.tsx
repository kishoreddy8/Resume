...
export function CommandBar() {
  ...
  const commands = useMemo<Command[]>(() => {
    ...
    const base: Command[] = [
      { id: "nav-home", label: "Home", group: "Go to", keywords: "start overview today what next", run: go("/home") },
      { id: "nav-resume", label: "Resume", group: "Go to", keywords: "master skills evidence intelligence tailoring versions", run: go("/resume") },
