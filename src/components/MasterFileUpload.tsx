...
/**
 * One master-file upload slot, shared by the setup screen and the Master Files page.
 *
 * Extracted rather than duplicated because the drop target here carries a real fix: it began as a
 * bare <input type="file"> with no cursor, no hover and no focus ring, and a tester reported that
 * nothing indicated it was clickable. A second copy would eventually drift back to that.
 */
...
export type Manifest = Partial<Record<"resume" | "skills", ManifestEntry>>;
