// "google_jobs" and "indeed" are Stage 7 EXTERNAL SECONDARY sources only — never a valid
// companies.source_type (no official connector, never scan-eligible, never returned by
// listScanReadyCompanies' hardcoded provider allowlist). They exist solely so a secondary-sourced
