...
**Summary standards.** The full summary rule — identity opening, 3-sentence structure, dynamic named-technology ceiling, no bolted-on closing tool-list sentence — is stated once, in PROFESSIONAL IDENTITY above; follow it exactly rather than restating your own structure. Publication-ready on the first pass. Do not use sentence fragments ("Design layered lakehouses...", "Work across Python..."). Write in polished executive resume register. Reject generic marketing fluff ("results-driven", "highly motivated", "seasoned professional", "proven track record"). Do not stack template stems ("Expertise spans...", "Proven ability to...", "Experienced in...").
